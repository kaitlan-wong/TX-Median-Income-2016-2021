---
title: "7 - Median Full-Time Income"
author: "Kaitlan Wong"
date: "2023-04-17"
...
usa_ddi <- read_ipums_ddi("usa_00028.xml")
acs_data <- read_ipums_micro("usa_00028.xml", data_file = ("usa_00028.csv.gz"), verbose = FALSE)
...
```{r}
# view(acs_data)
# I get an error message when I try to view the data
...
# Output returns tibble with 0 rows. There must be an issue with the city-level data from IPUMS. 

# Unable to continue past this point. :(
